...
export default function InternalUsersTable() {
    ...
    const deleteMutation = useMutation(
        ...
        },
        {
            onSuccess: () => {
                ...
                queryClient.invalidateQueries("internal_users");
            },
    ...
    const filteredItems = React.useMemo(() => {
        let filteredUsers = internalUsers ? [...internalUsers] : [];
                        ...
                        <Dropdown>
                            ...
                            <DropdownMenu>
                                <DropdownItem
                                    key="Editar"
                                    value="Editar"
                                    onClick={() => router.push(`${ROUTES.internalForm}/${user.id}`)}
                                >
                                    Editar
                                </DropdownItem>
                                <DropdownItem
