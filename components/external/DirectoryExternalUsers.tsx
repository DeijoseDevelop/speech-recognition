...
const DirectoryExternalUsers = () => {
    const router = useRouter();

    return (
        <div className="container mx-auto p-4 h-screen overflow-y-auto pb-24">
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                <h1 className="text-2xl font-bold mb-2 sm:mb-0">Directorio de usuarios externos</h1>
                <div className="flex gap-2">
                    <Button
                        size="sm"
                        onPress={() => router.replace(ROUTES.externalForm)}
...
export default DirectoryExternalUsers;
