...
const InternalUserForm: React.FC<InternalUserFormProps> = ({ user }) => {
    ...
    return (
        <div className="container mx-auto p-4 h-[calc(100vh-4rem)] md:h-5/6 lg:h-screen overflow-y-auto">
            <h1 className="text-2xl font-bold mb-4">
                {user ? "Editar Usuario Interno" : "Nuevo Usuario Interno"}
            </h1>
            ...
            <Breadcrumbs className="mb-4">
                ...
                <BreadcrumbItem>{user ? "Editar Usuario Interno" : "Nuevo Usuario Interno"}</BreadcrumbItem>
            </Breadcrumbs>
